...
#define ASSIST_LEVEL_0      0.50
#define ASSIST_LEVEL_1      1.00
#define ASSIST_LEVEL_2      1.75
#define ASSIST_LEVEL_3      3.00
#define ASSIST_LEVEL_4      5.25
#define ASSIST_LEVEL_5      9.20
...
#define ADC_BATTERY_CURRENT_MAX 16 // 10 amps (0.625 amps each unit)
